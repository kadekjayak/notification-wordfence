...
<table class="form-table">
    <tbody>
        <tr>
            <th><?php echo __('Transport', 'notification-wordfence'); ?></th>
            <td>
                <select id="wf-notification-transport-options" name="data[selected_transport]">
                    <option value=""><?php echo __('Choose Transport', 'notification-wordfence'); ?></option>
...
<table class="form-table wf-notification-transport slack <?php echo ( @strtolower( $values['selected_transport'] ) == 'slack') ? 'show' : ''; ?> ">
    <tbody>
        ...
        <tr>
            <th><?php echo __('Hook URL', 'notification-wordfence'); ?></th>
            <td>
                <input value="<?php echo @$slack['url']; ?>" type="text" name="data[transport][slack][url]" value="" class="regular-text" />
                <p class="description">
                    <?php echo __('Create your Incoming Webhook:', 'notification-wordfence'); ?> <a href="https://api.slack.com/messaging/webhooks" target="_blank">https://api.slack.com/messaging/webhooks</a>
                </p>
            </td>
        </tr>
        <tr>
            <th><?php echo __('Username', 'notification-wordfence'); ?></th>
            <td>
                <input value="<?php echo @$slack['username']; ?>" type="text" name="data[transport][slack][username]" value="" class="regular-text" />
            </td>
        </tr>
        <tr>
            <th><?php echo __('Channel', 'notification-wordfence'); ?></th>
            <td>
...
<table class="form-table wf-notification-transport telegram <?php echo ( @strtolower( $values['selected_transport'] ) == 'telegram') ? 'show' : ''; ?>">
    <tbody>
        <tr>
            <th><?php echo __('Bot Token', 'notification-wordfence'); ?></th>
            <td>
                ...
                <p class="description">
                    <?php echo __('Create your Bot:', 'notification-wordfence'); ?> <a href="https://core.telegram.org/bots#6-botfather" target="_blank">https://core.telegram.org/bots#6-botfather</a>
                </p>
            </td>
        </tr>
        <tr>
            <th><?php echo __('Chat ID / User ID', 'notification-wordfence'); ?></th>
            <td>
